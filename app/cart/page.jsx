...
export default function Cart() {
  ...
  const handleCheckout = async () => {
    try {
      const response = await axios.get('https://backend-green-heaven-git-main-hajar-bendhibas-projects.vercel.app/api/user', {
  ...
  const handlePlaceOrder = async () => {
    try {
      ...
      // Place the order
      const response = await axios.post('https://backend-green-heaven-git-main-hajar-bendhibas-projects.vercel.app/api/orders', orderData, {
        withCredentials: true
      });
