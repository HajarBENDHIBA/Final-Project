...
export default function ManageProducts() {
  ...
  const handleDelete = async (id) => {
    if (window.confirm('Are you sure you want to delete this product?')) {
      try {
        await axios.delete(`https://backend-green-heaven-git-main-hajar-bendhibas-projects.vercel.app/api/products/${id}`);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `https://backend-green-heaven-git-main-hajar-bendhibas-projects.vercel.app/api/products/${editingProduct._id}`,
        productData
      );
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://backend-green-heaven-git-main-hajar-bendhibas-projects.vercel.app/api/products', productData);
