...
export default function ManageUsers() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await fetch('https://backend-green-heaven-git-main-hajar-bendhibas-projects.vercel.app/api/users'); // Adjust API endpoint if needed
  ...
  const handleDeleteUser = async (id) => {
    ...
    try {
      const response = await axios.delete(`https://backend-green-heaven-git-main-hajar-bendhibas-projects.vercel.app/api/users/${id}`, {
